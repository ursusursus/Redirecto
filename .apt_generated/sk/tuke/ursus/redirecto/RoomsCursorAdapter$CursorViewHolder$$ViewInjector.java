...
public class RoomsCursorAdapter$CursorViewHolder$$ViewInjector {
  public static void inject(Finder finder, final sk.tuke.ursus.redirecto.RoomsCursorAdapter.CursorViewHolder target, Object source) {
    ...
    if (view == null) {
      throw new IllegalStateException("Required view with id '2131296340' for field 'overflow' was not found. If this view is optional add '@Optional' annotation.");
    }
    target.overflow = (android.widget.ImageButton) view;
    view = finder.findById(source, 2131296339);
    if (view == null) {
      throw new IllegalStateException("Required view with id '2131296339' for field 'view' was not found. If this view is optional add '@Optional' annotation.");
    }
    target.view = view;
  }
